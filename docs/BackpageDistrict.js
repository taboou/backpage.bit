...
/*******************************************************************************
 *
 * @notice A district will manage the ads placed in it.
 *
 *         Name         : Queens, New York, US
 *         Total supply : 100,000,000
 *         Decimals     : 6
 *
 * @dev A district offers a hybrid function as an aggregator of postings
        and management opportunities.
 */
contract TabooDistrict is ERC20Interface, Owned {
    using SafeMath for uint;

    string public name;
    string public region;
    string public country_code;
